...
function numberToSpeech(number) {
  ...
  if (typeof number != "number") {
    ...
    console.log("ketqua after add - = " + ketqua); // var audio = new Audio("../../sound/0.wav");
...
function decimalToSpeech(number) {
  ...
  if (typeof number != "number") {
    ...
    console.log("decimalPartInString = " + decimalPartInString); // decimalPart = parseInt(decimalPartInString);
...
CustomFunctions.associate("NUMBERTOSPEECH", numberToSpeech);
CustomFunctions.associate("NUMBERTOTEXT", numberToText);
CustomFunctions.associate("DECIMALTOSPEECH", decimalToSpeech);
CustomFunctions.associate("DECIMALTOTEXT", decimalToText);
